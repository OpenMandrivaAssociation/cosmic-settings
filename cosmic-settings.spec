...
Source0:        https://github.com/pop-os/cosmic-settings/archive/epoch-%{version}-alpha.1/%{name}-epoch-%{version}-alpha.1.tar.gz
...
%{_datadir}/applications/%{appname}.{About,Appearance,DateTime,Desktop,Displays,Dock,Firmware,Keyboard,Mouse,Notifications,Panel,RegionLanguage,Sound,Touchpad,Users,Wallpaper,WindowManagement,Workspaces}.desktop
%{_datadir}/cosmic
